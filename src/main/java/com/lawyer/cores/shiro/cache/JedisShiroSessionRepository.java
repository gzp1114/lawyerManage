...
import com.lawyer.cores.shiro.session.CustomSessionManager;
import com.lawyer.cores.shiro.session.SessionStatus;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "lawyer-shiro-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*lawyer-shiro-session:*";
